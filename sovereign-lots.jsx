...
const STRINGS = {
  en: {
    ...
    claimNote: "One allocation per verified wallet — the contract version gates this behind identity, not just a checkbox.",
  ...
  ka: {
    ...
    landingSubtitle: "წაიკითხეთ მოთხოვნამდე — ერთი წუთი დასჭირდება",
    ...
    claimNote: "ერთი განაწილება დადასტურებულ საფულეზე — რეალურად ამას იდენტობის დადასტურებით შემოფარგლავს კონტრაქტების ვერსია, და არა უბრალო გადამოწმება.",
...
const LANDING_SECTIONS = {
  ...
  ka: [
    { title: "1. მოქალაქეობა ერთჯერადი, ისტორიული ფაქტია", body: "მოქალაქედ ითვლება მხოლოდ ის საფულე, რომელიც დადასტურდა და მოითხოვა თანხა თავდაპირველი პრივატიზაციის პერიოდში. ამ ფანჯრის დახურვის შემდეგ, არავინ — მოქალაქე იქნება თუ არა — ვეღარასდროს მიიღებს ახალ უფასო რაოდენობას." },
    ...
    { title: "3. კომპანიის ნახევრად გაყიდვისთანავე, აქციონერები მართავენ მას", body: "როგორც კი კომპანიის აქციების სულ ცოტა ნახევარს ეყოლება რეალური მფლობელი, ნებისმიერ აქციონერს შეუძლია დაასახელოს საკუთარი კანდიდატურა მოკლე პროგრამით (დაახლოებით 700 სიტყვა). სხვა აქციონერები კენჭს უყრიან, წონით იმის მიხედვით, თუ რამდენი აქცია აქვთ ამ კომპანიაში." },
    ...
    { title: "5. გუბერნატორის ვადა ერთი თვეა — საკუთარი გასაღებით", body: "არჩეულ გუბერნატორს ეძლევა 30 დღის უფლებამოსილება. არჩევნებში გამარჯვება პირდაპირ არ გადასცემს კონტროლს — გუბერნატორი ამ ვადით კომპანიის სამართავად რეგისტრირებს ახალ, ცალკე გასაღების წყვილს, პირადი საფულისგან დამოუკიდებელს. ვადის დასრულებისას ეს გასაღები მთლიანად წყვეტს მუშაობას, და ვინც შემდეგ არჩევნებში გაიმარჯვებს, დაარეგისტრირებს სულ ახალს." },
    ...
    { title: "8. მოგვიანებით შემოერთება ნიშნავს შესყიდვას — არასდროს უფასოდ", body: "ვინც არ იყო მოქალაქე თავდაპირველი პრივატიზაციის დროს, უფასო რაოდენობის მიღების გზა არ აქვს. მათი ერთადერთი გზა შემოსასვლელად არის სპარე INVEST-ის ყიდვა მოქალაქისგან ან კომპანიის ხაზინიდან, დამტკიცებულ კრიპტოაქტივში გადახდით. ამ სისტემაში არსად არის ფიატის შესასვლელი — არც საბანკო გადარიცხვა, არც ბარათით გადახდა, არაფერი, რაც მიბმულია სახელმწიფო ვალუტაზე, განზრახ." },
