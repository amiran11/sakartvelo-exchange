...
const LANDING_SECTIONS = {
  ...
  ka: [
    { title: "1. მოქალაქეობა ერთჯერადი, ისტორიული ფაქტია", body: "მოქალაქედ ითვლება მხოლოდ ის საფულე, რომელიც დადასტურდა და მოითხოვა თანხა თავდაპირველი პრივატიზაციის პერიოდში. ამ ფანჯრის დახურვის შემდეგ, არავინ — მოქალაქედ არ ჩაითვლება — ანუ ვეღარასდროს მიიღებს ახალ უფასო რაოდენობას." },
